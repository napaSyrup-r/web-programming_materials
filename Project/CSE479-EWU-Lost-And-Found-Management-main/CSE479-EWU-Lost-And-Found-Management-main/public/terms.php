...
$page = query("SELECT title,content_html FROM pages WHERE slug='terms' LIMIT 1")->get_result()->fetch_assoc();
?>
<!doctype html>
<html lang="en">
  <head>
    ...
    <title><?= esc($page['title'] ?? 'Terms & Conditions') ?> · Lost & Found</title>
  ...
  <body>
    ...
    <main class="container" style="padding-top:1rem;max-width:860px;">
      <div class="card"><div class="card-body">
        <h2 class="card-title"><?= esc($page['title'] ?? 'Terms & Conditions') ?></h2>
